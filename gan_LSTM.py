...
class DCGAN():
    ...
    def build_generator(self):
        ...
        model = Sequential()
        model.add(Dense(49, activation='relu', input_dim = self.latent_dim))
...
if __name__ == '__main__':
    dcgan = DCGAN()
    dcgan.train(epochs=50000, batch_size=32, save_interval=500)
